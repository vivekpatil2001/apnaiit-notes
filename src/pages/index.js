...
const technologyList = [
  ...
  { title: 'JavaScript', link: '/docs/category/javascript', logo: 'icon/javas.png' },
  { title: 'React JS', link: '/docs/category/react-js', logo: 'icon/react.png' },
  { title: 'Tailwind CSS', link: '/docs/category/tailwind-css', logo: 'icon/tailwindc.png' },
  { title: 'Bootstrap', link: '/docs/category/mongodb', logo: 'icon/bootstrap.png' },
  { title: 'MongoDB', link: '/docs/category/mongodb', logo: 'icon/machinelearning.png' },
  { title: 'Node JS', link: '/docs/category/node--js', logo: 'icon/node.png' },
  ...
  { title: 'Java', link: '/docs/category/html', logo: 'icon/java.png' },
  { title: 'Spring Boot', link: '/docs/category/html', logo: 'icon/springboot.png' },
  { title: 'Python', link: '/docs/category/python', logo: 'icon/python.png' },
  { title: 'Flask', link: '/docs/category/html', logo: 'icon/flask.png' },
  { title: 'Django', link: '/docs/category/html', logo: 'icon/django.png' },
